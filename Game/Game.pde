...
public Serial arduinoSerial= new Serial(this, Serial.list()[0], 9600 ); //Conexion al Serial
...
void mouseClicked() {
  //INCLUIR VARIABLE PARA SELECTOR DE CONTROLES
  if (true) {
...
void keyPressed() {
  ...
  /*ACTUALMENTE SUSTITUIDO POR BOTON
